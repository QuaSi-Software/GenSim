...
Sub CreateResults()
    ...
    For colIndex = 1 To iMaxCol
        'Verluste
        If (InStr(ResultsNFAAnnual(1, colIndex), "Zone Opaque Surface Inside Faces Total Conduction Heat Loss Energy")) Then Sheets("GEBÄUDEBILANZ").Range("N10") = ResultsNFAAnnual(2, colIndex) * -1 * 0.001
        If (InStr(ResultsNFAAnnual(1, colIndex), "Zone Windows Total Heat Loss Energy")) Then Sheets("GEBÄUDEBILANZ").Range("N11") = ResultsNFAAnnual(2, colIndex) * -1 * 0.001
        If (InStr(ResultsNFAAnnual(1, colIndex), "Zone Infiltration Sensible Heat Loss Energy")) Then Sheets("GEBÄUDEBILANZ").Range("N12") = ResultsNFAAnnual(2, colIndex) * -1 * 0.001
        If (InStr(ResultsNFAAnnual(1, colIndex), "Zone Ventilation Sensible Heat Loss Energy")) Then Sheets("GEBÄUDEBILANZ").Range("N13") = ResultsNFAAnnual(2, colIndex) * -1 * 0.001
        If (InStr(ResultsNFAAnnual(1, colIndex), "Zone Air Terminal Sensible Cooling Energy")) Then Sheets("GEBÄUDEBILANZ").Range("N14") = ResultsNFAAnnual(2, colIndex) * -1 * 0.001

        'Gewinne
        If (InStr(ResultsNFAAnnual(1, colIndex), "Zone Opaque Surface Inside Faces Total Conduction Heat Gain Energy")) Then Sheets("GEBÄUDEBILANZ").Range("N18") = ResultsNFAAnnual(2, colIndex) * 0.001
        If (InStr(ResultsNFAAnnual(1, colIndex), "Zone Windows Total Heat Gain Energy")) Then Sheets("GEBÄUDEBILANZ").Range("N19") = ResultsNFAAnnual(2, colIndex) * 0.001
        If (InStr(ResultsNFAAnnual(1, colIndex), "Zone Infiltration Sensible Heat Gain Energy")) Then Sheets("GEBÄUDEBILANZ").Range("N20") = ResultsNFAAnnual(2, colIndex) * 0.001
        If (InStr(ResultsNFAAnnual(1, colIndex), "Zone Ventilation Sensible Heat Gain Energy")) Then Sheets("GEBÄUDEBILANZ").Range("N21") = ResultsNFAAnnual(2, colIndex) * 0.001
        If (InStr(ResultsNFAAnnual(1, colIndex), "Zone Electric Equipment Total Heating Energy")) Then Sheets("GEBÄUDEBILANZ").Range("N22") = ResultsNFAAnnual(2, colIndex) * 0.001
        If (InStr(ResultsNFAAnnual(1, colIndex), "Zone Lights Total Heating Energy")) Then Sheets("GEBÄUDEBILANZ").Range("N23") = ResultsNFAAnnual(2, colIndex) * 0.001
        If (InStr(ResultsNFAAnnual(1, colIndex), "Zone People Sensible Heating Energy")) Then Sheets("GEBÄUDEBILANZ").Range("N24") = ResultsNFAAnnual(2, colIndex) * 0.001
        If (InStr(ResultsNFAAnnual(1, colIndex), "Zone Air Terminal Sensible Heating Energy")) Then Sheets("GEBÄUDEBILANZ").Range("N25") = ResultsNFAAnnual(2, colIndex) * 0.001
        
        ' heating and cooling
        If (InStr(ResultsNFAAnnual(1, colIndex), "Baseboard Total Heating Energy")) Then Sheets("GEBÄUDEBILANZ").Range("N31") = ResultsNFAAnnual(2, colIndex) * 0.001
        If (InStr(ResultsNFAAnnual(1, colIndex), "Zone Radiant HVAC Cooling Energy")) Then Sheets("GEBÄUDEBILANZ").Range("N32") = ResultsNFAAnnual(2, colIndex) * 0.001
    Next
