...
Const METER_ZONE_PLUGS = "METER ELECTRIC EQUIPMENT HEAT GAIN"
Const METER_ZONE_LIGHTS = "METER LIGHTS HEAT GAIN"
Const METER_ZONE_PEOPLE = "METER PEOPLE HEAT GAIN"

Const METER_WINDOW_SURFACE_HEAT_GAIN = "METER WINDOW CONDUCTION HEAT GAIN"
Const METER_WINDOW_SURFACE_HEAT_LOSS = "METER WINDOW CONDUCTION HEAT LOSS"

Const METER_INTERNAL_LOADS = "METER INTERNAL LOADS HEAT GAIN"

Const METER_SURFACE_FACE_CONDUCTION_TOTAL = "METER WALL CONDUCTION HEAT TRANSFER"
Const METER_SURFACE_FACE_CONDUCTION_LOSS = "METER WALL CONDUCTION HEAT GAIN"
Const METER_SURFACE_FACE_CONDUCTION_GAIN = "METER WALL CONDUCTION HEAT LOSS"

Const METER_INFILTRATION_HEAT_LOSS = "METER INFILTRATION HEAT LOSS"
Const METER_INFILTRATION_HEAT_GAIN = "METER INFILTRATION HEAT GAIN"
Const METER_VENTILATION_HEAT_LOSS = "METER WINDOW VENTILATION HEAT LOSS"
Const METER_VENTILATION_HEAT_GAIN = "METER WINDOW VENTILATION HEAT GAIN"
Const METER_MECHANICAL_VENTILATION_LOSS = "METER MECHANICAL VENTILATION HEAT LOSS"
Const METER_MECHANICAL_VENTILATION_GAIN = "METER MECHANICAL VENTILATION HEAT GAIN"
...
Sub CreateResults()
    ...
    For colIndex = 1 To iMaxCol
        'Verluste
        If (InStr(ResultsNFAAnnual(1, colIndex), METER_SURFACE_FACE_CONDUCTION_LOSS)) Then Sheets("GEBÄUDEBILANZ").Range("N10") = ResultsNFAAnnual(2, colIndex) * -1 * 0.001
        ...
        'Gewinne
        If (InStr(ResultsNFAAnnual(1, colIndex), METER_SURFACE_FACE_CONDUCTION_GAIN)) Then Sheets("GEBÄUDEBILANZ").Range("N18") = ResultsNFAAnnual(2, colIndex) * 0.001
